...
public final class RecipeSaveData extends SavedData {
    ...
    public static SavedData.Factory<RecipeSaveData> factory() {
        // Custom mod data uses no DataFixTypes (null), matching the NeoForge port.
        // 模组自定义数据不涉及 DataFixers，第三参数传 null。
        return new SavedData.Factory<>(RecipeSaveData::new, RecipeSaveData::load, null);
    }
}